...
export const researchThemes: ResearchTheme[] = [
  ...
  },
  {
    ...
    contribution: 'My coauthored computer vision research examines competitive feature selection for finger vein recognition and complementary state space, linear-attention, and frequency-aware approaches to breast tumor segmentation.',
